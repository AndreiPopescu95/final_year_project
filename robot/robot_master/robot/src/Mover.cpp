...
int main(int argc, char **argv)
{
    ...
    ros::Publisher movement_pub = n.advertise<geometry_msgs::Twist>("/pioneer/cmd_vel",1); //for sensors the value after , should be higher to get a more accurate result (queued)
